            ...
            <div class="w-3/7 lg:w-auto">
                ...
                <div class="text-sm">
                    ...
                    <NuxtLink
                        :to="wishlistLink"
                        class="py-1.5 block"
                        >{{ $t('messages.shop.wishlist') }}</NuxtLink
                    >
                    <a
                        href="/"
                        class="py-1.5 block"
                        >{{ $t('messages.general.newsletter') }}</a
                    >
                </div>
            </div>
        </div>
        <div class="container border-t flex items-center justify-center">
            <div class="copywrite">
                <p class="py-4 text-xs text-center">Jeannie’s Tilapia Chips © {{ new Date().getFullYear() }}</p>
            </div>
