import { defineComponent, useSSRContext, defineAsyncComponent, withCtx, unref, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, computed, mergeProps, ref, watch, withAsyncContext } from 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/vue/index.mjs';
import { c as _export_sfc, h as useHead, i as useHelpers, d as useRoute, z as useImage, o as useAppConfig, u as useCart, p as useI18n, e as useAsyncGql, A as showError, n as useRuntimeConfig, f as __nuxt_component_1$2, g as __nuxt_component_0$3, _ as __nuxt_component_0$5, b as __nuxt_component_2$2 } from './server.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderSlot, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderStyle, ssrLooseEqual } from 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/vue/server-renderer/index.mjs';
import { _ as __nuxt_component_0$1$1, a as __nuxt_component_1$1 } from './ProductCard-DSPys-8O.mjs';
import { _ as __nuxt_component_6 } from './ProductPrice-BLA-t2Nu.mjs';
import { S as StockStatusEnum, P as ProductTypesEnum } from './default-DhvGO-Ho.mjs';
import { u as useWishlist } from './useWishlist-8cnX3cJ-.mjs';
import { _ as _sfc_main$d } from './ProductRow-CnS40oEy.mjs';
...
import 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/@heroicons/vue/24/outline/esm/index.js';
...
const __nuxt_component_0$2 = Object.assign(_sfc_main$c, { __name: "SEOHead" });
...
const __nuxt_component_1 = Object.assign(_sfc_main$b, { __name: "Breadcrumb" });
const imgWidth = 640;
  ...
  setup(__props) {
    ...
    const galleryImages = computed(() => {
      return [primaryImage.value, ...props.gallery.nodes].filter(
        (img, index, self) => index === self.findIndex((t) => (t == null ? void 0 : t.databaseId) === (img == null ? void 0 : img.databaseId))
      );
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SaleBadge = __nuxt_component_0$1$1;
      const _component_NuxtImg = __nuxt_component_0$3;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-415b8e49>`);
      ...
      if (__props.gallery.nodes.length) {
        _push(`<div class="my-4 gallery-images" data-v-415b8e49><!--[-->`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$a, [["__scopeId", "data-v-415b8e49"]]), { __name: "ProductImageGallery" });
...
const __nuxt_component_7 = Object.assign(_sfc_main$9, { __name: "StockStatus" });
...
const __nuxt_component_0$1 = Object.assign(_sfc_main$8, { __name: "Tooltip" });
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getSelectedName = (attr, activeVariation) => {
      var _a, _b;
      if (((_a = attr == null ? void 0 : attr.terms) == null ? void 0 : _a.nodes) && activeVariation) {
        return (_b = attr.terms.nodes.find((node) => node.slug === activeVariation.value)) == null ? void 0 : _b.name;
      }
      return (activeVariation == null ? void 0 : activeVariation.value) || "";
    };
    const updateAttrs = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Tooltip = __nuxt_component_0$1;
      if (_ctx.attributes) {
        ...
        ssrRenderList(_ctx.attributes, (attr, i) => {
          ...
          if (attr.scope == "LOCAL") {
            ...
            if (unref(activeVariations).length && unref(activeVariations)[i]) {
              _push(`<span class="text-gray-400">: ${ssrInterpolate(getSelectedName(attr, unref(activeVariations)[i]))}</span>`);
            } else {
              _push(`<!---->`);
            }
...
const __nuxt_component_8 = Object.assign(_sfc_main$7, { __name: "AttributeSelections" });
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-fc9c4d6c><span data-v-fc9c4d6c>${ssrInterpolate(unref(addToCartButtonText))}</span>`);
      if (unref(isLoading)) {
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-fc9c4d6c"]]);
...
const __nuxt_component_11 = Object.assign(_sfc_main$5, { __name: "WishlistButton" });
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const twitterUrl = computed(
      () => `https://twitter.com/intent/tweet?text=${props.product.name}&url=${(void 0).location.href}`
    );
...
const __nuxt_component_12 = Object.assign(_sfc_main$4, { __name: "ShareButton" });
const _sfc_main$3 = {
  __name: "ReviewsScore",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_StarRating = __nuxt_component_1$1;
      const _component_Icon = __nuxt_component_0$5;
      const _component_LoadingIcon = __nuxt_component_2$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-e967660c>`);
      if (__props.reviews.edges.length) {
        _push(`<h4 class="font-semibold text-2xl text-gray-900" data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.shop.customerReviews"))}</h4>`);
      } else {
        _push(`<h4 class="font-semibold text-2xl text-gray-900" data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.shop.noReviews"))}</h4>`);
      }
      if (__props.reviews.edges.length) {
        _push(`<div class="my-2" data-v-e967660c>`);
        _push(ssrRenderComponent(_component_StarRating, {
          rating: __props.reviews.averageRating,
          "hide-count": true,
          class: "text-sm mr-2"
        }, null, _parent));
        _push(`<span class="text-sm" data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.general.basedOn"))} ${ssrInterpolate(__props.reviews.edges.length)} ${ssrInterpolate(_ctx.$t("messages.shop.reviews"))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="my-4 bars" data-v-e967660c><!--[-->`);
      ssrRenderList(unref(numberAndPercentageOfEachRating), (rating2) => {
        _push(`<div class="flex gap-4 items-center" data-v-e967660c><div class="flex text-sm gap-1 items-center" data-v-e967660c>${ssrInterpolate(rating2.rating)} `);
        _push(ssrRenderComponent(_component_Icon, {
          class: "text-yellow-400",
          name: "ion:star"
        }, null, _parent));
        _push(`</div><div class="flex-1 relative" data-v-e967660c><div class="rounded-full bg-gray-200 h-2.5 w-full" data-v-e967660c></div><div class="rounded-full bg-yellow-400 h-2.5 top-0 left-0 absolute" style="${ssrRenderStyle({ width: rating2.percentage + "%" })}" data-v-e967660c></div></div></div>`);
      });
      _push(`<!--]--></div><div class="mt-10 text-xl mb-2 text-gray-900" data-v-e967660c>Share your thoughts</div><div class="text-sm mb-4" data-v-e967660c>If you have used this product, we would love to hear about your experience.</div><button class="border rounded-lg text-center w-full p-2" data-v-e967660c>${ssrInterpolate(unref(show) ? _ctx.$t("messages.shop.close") : _ctx.$t("messages.shop.writeReview"))}</button>`);
      if (unref(show)) {
        _push(`<form class="writeReview" data-v-e967660c><div class="w-full text-gray-500" data-v-e967660c><div class="p-5 mt-3 grid gap-2 border rounded-lg" data-v-e967660c><div class="block text-center mb-1.5" data-v-e967660c><label class="text-center text-sm block relative m-auto" data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.shop.rateReview"))} <span class="text-red-500" data-v-e967660c>*</span></label><div class="gap-1 flex justify-center mt-2 relative" data-v-e967660c><!--[-->`);
        ssrRenderList(5, (i) => {
          _push(`<label class="${ssrRenderClass([unref(rating) < i && i > unref(hovered) ? "disable-star" : "checked-star", "grid p-1 rounded"])}" data-v-e967660c><input type="radio" class="overflow-hidden appearance-none opacity-0 absolute" name="rating"${ssrRenderAttr("value", i)}${ssrIncludeBooleanAttr(ssrLooseEqual(unref(rating), i)) ? " checked" : ""} required data-v-e967660c>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "ion:star",
            size: __props.size + ""
          }, null, _parent));
        ...
        _push(`<!--]--></div></div><div class="w-full col-span-full" data-v-e967660c><label for="content" class="text-sm mb-0.5" data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.shop.rateContent"))} <span class="text-red-500" data-v-e967660c>*</span></label><textarea class="w-full" id="content" placeholder="Great Quality" required data-v-e967660c>${ssrInterpolate(unref(content))}</textarea></div><div class="w-full col-span-full" data-v-e967660c><label for="author" class="text-sm mb-0.5" data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.shop.rateEmail"))} <span class="text-red-500" data-v-e967660c>*</span></label><input class="w-full" id="author" placeholder="example@example.com" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$"${ssrRenderAttr("value", unref(authorEmail))} required data-v-e967660c></div>`);
        if (unref(errorMessage)) {
          _push(`<div class="my-4 text-sm text-red-500" data-v-e967660c>${unref(errorMessage) ?? ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(successMessage)) {
          _push(`<div class="my-4 text-sm text-green-500" data-v-e967660c>${unref(successMessage) ?? ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="w-full col-span-full text-center mt-3" data-v-e967660c><button class="flex gap-4 justify-center items-center transition font-semibold rounded-md w-full p-2 bg-amber-300 text-amber-900 hover:bg-amber-400" type="submit" data-v-e967660c>`);
        if (unref(isPending)) {
          _push(ssrRenderComponent(_component_LoadingIcon, {
            stroke: "4",
            size: "16",
        ...
        _push(`<span data-v-e967660c>${ssrInterpolate(_ctx.$t("messages.shop.submit"))}</span></button></div></div></div></form>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e967660c"]]);
const _sfc_main$2 = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_a = __props.product.reviews) == null ? void 0 : _a.edges) && __props.product.reviews.edges.length) {
        ...
        ssrRenderList(__props.product.reviews.edges, (review) => {
          ...
          _push(`<div class="grid gap-1"><div class="text-sm"><span class="font-semibold">${ssrInterpolate(review.node.author.node.name)}</span><span class="italic text-gray-400"> – ${ssrInterpolate(new Date(review.node.date).toLocaleString(_ctx.$t("messages.general.langCode"), {
            month: "long",
            day: "numeric",
            year: "numeric"
          }))}</span></div>`);
          ...
          _push(`</div></div><div class="mt-4 text-gray-700 italic prose-sm">${review.node.content ?? ""}</div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-3c89052d><nav class="border-b flex gap-8 tabs" data-v-3c89052d>`);
      if (__props.product.description) {
        _push(`<button type="button" class="${ssrRenderClass(unref(show) === 0 ? "active" : "")}" data-v-3c89052d>${ssrInterpolate(_ctx.$t("messages.shop.productDescription"))}</button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(storeSettings).showReviews) {
        _push(`<button type="button" class="${ssrRenderClass(unref(show) === 1 ? "active" : "")}" data-v-3c89052d>${ssrInterpolate(_ctx.$t("messages.shop.reviews"))} (${ssrInterpolate(__props.product.reviewCount)}) </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</nav><div class="tab-contents" data-v-3c89052d>`);
      if (unref(show) === 0 && __props.product.description) {
        _push(`<div class="font-light mt-8 prose" data-v-3c89052d>${__props.product.description ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(show) === 1) {
...
const __nuxt_component_13 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-3c89052d"]]), { __name: "ProductTabs" });
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./WPAdminLink-BgqDkn54.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2, _b2;
      const _component_SEOHead = __nuxt_component_0$2;
      ...
      const _component_StarRating = __nuxt_component_1$1;
      const _component_ProductPrice = __nuxt_component_6;
      const _component_StockStatus = __nuxt_component_7;
      const _component_AttributeSelections = __nuxt_component_8;
      const _component_AddToCartButton = __nuxt_component_9;
      const _component_NuxtLink = __nuxt_component_1$2;
      const _component_WishlistButton = __nuxt_component_11;
      const _component_ShareButton = __nuxt_component_12;
      const _component_ProductTabs = __nuxt_component_13;
      const _component_ProductRow = _sfc_main$d;
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "container relative py-6 xl:max-w-7xl" }, _attrs))} data-v-9d45c358>`);
      if (unref(product)) {
        _push(`<div data-v-9d45c358>`);
        ...
        _push(`<div class="flex flex-col gap-10 md:flex-row md:justify-between lg:gap-24" data-v-9d45c358>`);
        ...
        _push(`<div class="lg:max-w-md xl:max-w-lg md:py-2 w-full" data-v-9d45c358><div class="flex justify-between mb-4" data-v-9d45c358><div class="flex-1" data-v-9d45c358><h1 class="flex flex-wrap items-center gap-2 mb-2 text-2xl font-sesmibold" data-v-9d45c358>${ssrInterpolate(unref(type).name)} `);
        ...
        _push(`</div><div class="grid gap-2 my-8 text-sm empty:hidden" data-v-9d45c358>`);
        if (!unref(isExternalProduct)) {
          _push(`<div class="flex items-center gap-2" data-v-9d45c358><span class="text-gray-400" data-v-9d45c358>${ssrInterpolate(_ctx.$t("messages.shop.availability"))}: </span>`);
        ...
        if (unref(storeSettings).showSKU && unref(product).sku) {
          _push(`<div class="flex items-center gap-2" data-v-9d45c358><span class="text-gray-400" data-v-9d45c358>${ssrInterpolate(_ctx.$t("messages.shop.sku"))}: </span><span data-v-9d45c358>${ssrInterpolate(unref(product).sku || "N/A")}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="mb-8 font-light prose" data-v-9d45c358>${(unref(product).shortDescription || unref(product).description) ?? ""}</div><hr data-v-9d45c358><form data-v-9d45c358>`);
        ...
        if (unref(isVariableProduct) || unref(isSimpleProduct)) {
          _push(`<div class="fixed bottom-0 left-0 z-10 flex items-center w-full gap-4 p-4 mt-12 bg-white md:static md:bg-transparent bg-opacity-90 md:p-0" data-v-9d45c358><input${ssrRenderAttr("value", unref(quantity))} type="number" min="1" aria-label="Quantity" class="bg-white border rounded-lg flex text-left p-2.5 w-20 gap-4 items-center justify-center focus:outline-none" data-v-9d45c358>`);
        ...
        if (unref(isExternalProduct) && unref(product).externalUrl) {
          _push(`<a${ssrRenderAttr("href", unref(product).externalUrl)} target="_blank" class="rounded-lg flex font-bold bg-gray-800 text-white text-center min-w-[150px] p-2.5 gap-4 items-center justify-center focus:outline-none" data-v-9d45c358>${ssrInterpolate(((_b2 = unref(product)) == null ? void 0 : _b2.buttonText) || "View product")}</a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</form>`);
        if (unref(storeSettings).showProductCategoriesOnSingleProduct && unref(product).productCategories) {
          _push(`<div data-v-9d45c358><div class="grid gap-2 my-8 text-sm" data-v-9d45c358><div class="flex items-center gap-2" data-v-9d45c358><span class="text-gray-400" data-v-9d45c358>${ssrInterpolate(_ctx.$t("messages.shop.category", 2))}:</span><div class="product-categories" data-v-9d45c358><!--[-->`);
          ssrRenderList(unref(product).productCategories.nodes, (category) => {
            _push(ssrRenderComponent(_component_NuxtLink, {
              key: category.databaseId,
              to: `/product-category/${decodeURIComponent((category == null ? void 0 : category.slug) || "")}`,
              class: "hover:text-primary",
              title: category.name
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`${ssrInterpolate(category.name)}<span class="comma" data-v-9d45c358${_scopeId}>, </span>`);
                } else {
                  return [
          ...
          _push(`<!--]--></div></div></div><hr data-v-9d45c358></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="flex flex-wrap gap-4" data-v-9d45c358>`);
        ...
        if (unref(product).description || unref(product).reviews) {
          _push(`<div class="my-32" data-v-9d45c358>`);
        ...
        if (unref(product).related && unref(storeSettings).showRelatedProducts) {
          _push(`<div class="my-32" data-v-9d45c358><div class="mb-4 text-xl font-semibold" data-v-9d45c358>${ssrInterpolate(_ctx.$t("messages.shop.youMayLike"))}</div>`);
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9d45c358"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-DwQ1bIGC.mjs.map
