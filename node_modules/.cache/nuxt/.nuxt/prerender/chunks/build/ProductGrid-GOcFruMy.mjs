import { c as _export_sfc, w as useSorting, o as useAppConfig, x as useFiltering, i as useHelpers, e as useAsyncGql, d as useRoute, v as useProducts, y as useSearching, _ as __nuxt_component_0$5, n as useRuntimeConfig, f as __nuxt_component_1$2 } from './server.mjs';
import { toRefs, ref, computed, onMounted, onUnmounted, watch, openBlock, createElementBlock, mergeProps, useSSRContext, defineAsyncComponent, withAsyncContext, unref, defineComponent, withCtx, createVNode, createTextVNode, toDisplayString, isRef } from 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderSlot } from 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/vue/server-renderer/index.mjs';
import { T as TaxonomyEnum } from './default-DhvGO-Ho.mjs';
import { b as __nuxt_component_0$1 } from './ProductCard-DSPys-8O.mjs';
      ...
      if (__props.terms.length) {
        ...
        ssrRenderList(__props.terms, (term) => {
          ...
          if (__props.showCount) {
            _push(`<small class="ml-1 text-gray-400 tabular-nums" aria-hidden="true">(${ssrInterpolate(term.count || 0)})</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</label></div>`);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$5;
      _push(`<!--[--><div class="cursor-pointer flex font-semibold mt-8 leading-none justify-between items-center" data-v-43199cf1><span data-v-43199cf1>${ssrInterpolate(unref(filterTitle))}</span>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:chevron-down-outline",
        class: ["transform", unref(isOpen) ? "rotate-180" : ""]
      }, null, _parent));
      _push(`</div><div style="${ssrRenderStyle(unref(isOpen) ? null : { display: "none" })}" class="mt-3 mr-6 max-h-[240px] grid gap-1.5 swatches overflow-auto custom-scrollbar" data-v-43199cf1><!--[-->`);
      ssrRenderList(__props.attribute.terms, (color) => {
        _push(`<div style="${ssrRenderStyle({ "--color": color.slug })}"${ssrRenderAttr("title", color.name)} data-v-43199cf1><input${ssrRenderAttr("id", color.slug)}${ssrIncludeBooleanAttr(Array.isArray(unref(selectedTerms)) ? ssrLooseContain(unref(selectedTerms), color.slug) : unref(selectedTerms)) ? " checked" : ""} class="hidden" type="checkbox"${ssrRenderAttr("value", color.slug)} data-v-43199cf1><label${ssrRenderAttr("for", color.slug)} class="cursor-pointer m-0" data-v-43199cf1></label></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["__scopeId", "data-v-43199cf1"]]), { __name: "ColorFilter" });
...
const __nuxt_component_4$1 = Object.assign(_sfc_main$7, { __name: "GlobalFilter" });
const _sfc_main$6 = {
  __name: "OnSaleFilter",
  __ssrInlineRender: true,
  setup(__props) {
...
const __nuxt_component_6_lazy = defineAsyncComponent(() => import('./StarRatingFilter-sfb6d-qR.mjs').then((c) => c.default || c));
const __nuxt_component_7_lazy = defineAsyncComponent(() => import('./ResetFiltersButton-BU8G6ghl.mjs').then((c) => c.default || c));
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useAsyncGql("getAllTerms", { taxonomies: [...taxonomies, TaxonomyEnum.PRODUCTCATEGORY] })), __temp = await __temp, __restore(), __temp);
    const terms = ((_c = (_b = data.value) == null ? void 0 : _b.terms) == null ? void 0 : _c.nodes) || [];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_GlobalFilter = __nuxt_component_4$1;
      ...
      if (!__props.hideCategories) {
        _push(ssrRenderComponent(_component_CategoryFilter, { terms: unref(productCategoryTerms) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(unref(attributesWithTerms), (attribute) => {
        _push(`<div>`);
...
const __nuxt_component_0 = Object.assign(_sfc_main$5, { __name: "Filters" });
...
const __nuxt_component_1$1 = Object.assign(_sfc_main$4, { __name: "ProductResultCount" });
const _sfc_main$3 = {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0$5;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex justify-center mt-8 mb-16 col-span-full tabular-nums" }, _attrs))} data-v-41e0a215>`);
      if (unref(numberOfPages) && unref(numberOfPages) > 1) {
        _push(`<nav class="inline-flex self-end -space-x-px rounded-md shadow-sm isolate" aria-label="Pagination" data-v-41e0a215>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-41e0a215"]]), { __name: "Pagination" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(allProducts).length) {
        _push(`<button class="bg-primary rounded-lg font-bold mt-8 text-center text-white text-sm w-full p-2 px-3 inline-block hover:bg-primary-dark"${ssrRenderAttr("title", _ctx.$t("messages.shop.noProductsFound.clearFiltersAndSearch"))} aria-label="Clear all filters and search">${ssrInterpolate(_ctx.$t("messages.shop.noProductsFound.clearFiltersAndSearch"))}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div>`);
...
const __nuxt_component_5 = Object.assign(_sfc_main$1, { __name: "NoProductsFound" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NoProductsFound = __nuxt_component_5;
      if (!!unref(products).length) {
        _push(`<section class="relative w-full" data-v-aa0bb9a6><div${ssrRenderAttrs({
          name: "shrink",
          mode: "in-out",
          class: "product-grid"
        })} data-v-aa0bb9a6>`);
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-aa0bb9a6"]]), { __name: "ProductGrid" });

export { __nuxt_component_0 as _, __nuxt_component_1$1 as a, _sfc_main$b as b, _sfc_main$3 as c, __nuxt_component_4 as d, __nuxt_component_5 as e };
//# sourceMappingURL=ProductGrid-GOcFruMy.mjs.map
