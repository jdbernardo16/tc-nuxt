import { d as useRoute, k as useAuth, i as useHelpers, p as useI18n, q as useSeoMeta, b as __nuxt_component_2$2, f as __nuxt_component_1$2, _ as __nuxt_component_0$5, g as __nuxt_component_0$3 } from './server.mjs';
import { _ as __nuxt_component_3, a as __nuxt_component_5 } from './DownloadableItems-G69i48qj.mjs';
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, useSSRContext } from 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file:///home/runner/work/tc-nuxt/tc-nuxt/node_modules/vue/server-renderer/index.mjs';
import { O as OrderStatusEnum } from './default-DhvGO-Ho.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full min-h-[600px] flex items-center p-4 text-gray-800 md:bg-white md:rounded-xl md:mx-auto md:shadow-lg md:my-24 md:mt-8 md:max-w-3xl md:p-16 flex-col" }, _attrs))}>`);
      if (!unref(isLoaded)) {
        ...
        if (unref(order) && !unref(isGuest)) {
          _push(`<div class="flex-1 w-full"><div class="flex items-start justify-between"><div class="w-[21%]"><div class="mb-2 text-xs text-gray-400 uppercase">${ssrInterpolate(_ctx.$t("messages.shop.order"))}</div><div class="leading-none">#${ssrInterpolate(unref(order).databaseId)}</div></div><div class="w-[21%]"><div class="mb-2 text-xs text-gray-400 uppercase">${ssrInterpolate(_ctx.$t("messages.general.date"))}</div><div class="leading-none">${ssrInterpolate(unref(formatDate)(unref(order).date))}</div></div><div class="w-[21%]"><div class="mb-2 text-xs text-gray-400 uppercase">${ssrInterpolate(_ctx.$t("messages.general.status"))}</div>`);
          if (unref(order).status) {
            _push(ssrRenderComponent(_component_OrderStatusLabel, { order: unref(order) }, null, _parent));
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="w-[21%]"><div class="mb-2 text-xs text-gray-400 uppercase">${ssrInterpolate(_ctx.$t("messages.general.paymentMethod"))}</div><div class="leading-none">${ssrInterpolate(unref(order).paymentMethodTitle)}</div></div></div>`);
...
//# sourceMappingURL=order-summary-5xgE7kIS.mjs.map
