import { j as useState, k as useAuth, u as useCart, G as GqlUpdateCustomer, l as useRouter, i as useHelpers, m as GqlCheckout, c as _export_sfc, n as useRuntimeConfig, _ as __nuxt_component_0, o as useAppConfig, f as __nuxt_component_1$1, g as __nuxt_component_0$2, b as __nuxt_component_2, p as useI18n, d as useRoute, q as useSeoMeta } from "../server.mjs";
import { _ as __nuxt_component_1$2 } from "./PasswordInput-BAK7pHHm.js";
import { _ as _sfc_main$b, a as _sfc_main$c } from "./CountrySelect-Bbh0jiQO.js";
...
import "hookable";
import { _ as __nuxt_component_0$1 } from "./TrashIcon-CmuoZLJP.js";
import { useSwipe } from "@vueuse/core";
import { _ as __nuxt_component_6$1 } from "./ProductPrice-BLA-t2Nu.js";
import { u as useWishlist } from "./useWishlist-8cnX3cJ-.js";
...
const __nuxt_component_3 = Object.assign(_sfc_main$a, { __name: "BillingDetails" });
...
const __nuxt_component_4$1 = Object.assign(_sfc_main$9, { __name: "ShippingDetails" });
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid gap-4 shipping-options" }, _attrs))} data-v-7e5882bc><!--[-->`);
      ssrRenderList(__props.options, (option) => {
        _push(`<div class="${ssrRenderClass([{ "active-option": option.id === __props.activeOption }, "flex items-center justify-between option"])}" data-v-7e5882bc><div data-v-7e5882bc><div class="text-sm leading-tight text-gray-500" data-v-7e5882bc>${option.label ?? ""}</div><div class="font-semibold text-gray-600" data-v-7e5882bc>${ssrInterpolate(unref(currencySymbol))}${ssrInterpolate(option.cost)}</div></div>`);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-7e5882bc"]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex gap-4 leading-tight flex-wrap" }, _attrs))} data-v-bbe87a34><!--[-->`);
      ssrRenderList((_a = _ctx.paymentGateways) == null ? void 0 : _a.nodes, (gateway) => {
        _push(`<div class="${ssrRenderClass([{ "active-option": gateway.id === unref(activePaymentMethod).id }, "option"])}"${ssrRenderAttr("title", (gateway == null ? void 0 : gateway.description) || (gateway == null ? void 0 : gateway.title) || "Payment Method")} data-v-bbe87a34>`);
        ...
        _push(`<span class="whitespace-nowrap" data-v-bbe87a34>${gateway.title ?? ""}</span>`);
        _push(ssrRenderComponent(_component_icon, {
          name: "ion:checkmark-circle",
          size: "20",
          class: "ml-auto text-primary checkmark opacity-0"
      ...
      if (unref(activePaymentMethod).description) {
        _push(`<div class="prose block w-full" data-v-bbe87a34><p class="text-sm text-gray-500" data-v-bbe87a34>${unref(activePaymentMethod).description ?? ""}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-bbe87a34"]]), { __name: "PaymentOptions" });
...
const __nuxt_component_7 = Object.assign(_sfc_main$6, { __name: "StripeElement" });
const _sfc_main$5 = {
  __name: "SwipeCard",
  __ssrInlineRender: true,
  emits: ["remove"],
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex rounded bg-white text-sm leading-none shadow-sm shadow-gray-200 isolate" }, _attrs))} data-v-754b6da6><button title="Decrease Quantity" aria-label="Decrease Quantity" type="button" class="focus:outline-none border-r w-6 h-6 border rounded-l border-gray-300 hover:bg-gray-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(unref(isUpdatingCart) || unref(quantity) <= 0) ? " disabled" : ""} data-v-754b6da6>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:remove",
        size: "14"
      }, null, _parent));
      _push(`</button><input${ssrRenderAttr("value", unref(quantity))} type="number" min="0"${ssrRenderAttr("max", unref(productType).stockQuantity)} aria-label="Quantity" class="flex items-center justify-center w-8 px-2 text-right text-xs focus:outline-none border-y border-gray-300" data-v-754b6da6><button title="Increase Quantity" aria-label="Increase Quantity" type="button" class="focus:outline-none border-l w-6 h-6 border rounded-r hover:bg-gray-50 border-gray-300 disabled:cursor-not-allowed disabled:bg-gray-100"${ssrIncludeBooleanAttr(unref(isUpdatingCart) || unref(hasNoMoreStock)) ? " disabled" : ""} data-v-754b6da6>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:add",
        size: "14"
      }, null, _parent));
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-754b6da6"]]), { __name: "QuantityInput" });
const _sfc_main$3 = {
  __name: "CartCard",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProductPrice = __nuxt_component_6$1;
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LoadingIcon = __nuxt_component_2;
      const _component_Icon = __nuxt_component_0;
...
const __nuxt_component_1 = Object.assign(_sfc_main$2, { __name: "AddCoupon" });
const _sfc_main$1 = {
  __name: "OrderSummary",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AddCoupon = __nuxt_component_1;
      const _component_LoadingIcon = __nuxt_component_2;
      if (unref(cart)) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0;
      const _component_NuxtLink = __nuxt_component_1$1;
      const _component_PasswordInput = __nuxt_component_1$2;
      const _component_BillingDetails = __nuxt_component_3;
      const _component_ShippingDetails = __nuxt_component_4$1;
      const _component_ShippingOptions = __nuxt_component_5;
      const _component_PaymentOptions = __nuxt_component_6;
      const _component_StripeElement = __nuxt_component_7;
...
//# sourceMappingURL=checkout-JpbhXrYg.js.map
